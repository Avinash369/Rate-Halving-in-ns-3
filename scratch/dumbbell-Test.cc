...
int main (int argc, char *argv[])
{
  ...
  Config::SetDefault ("ns3::TcpL4Protocol::RecoveryType", TypeIdValue (TypeId::LookupByName ("ns3::TcpRateHalvingRecovery")));
  ...
  system ((dirToSave + "/inflightTraces/").c_str ());
...
//  gcs.ConfigureAttributes ();
  ...
  //pointToPointLeaf.EnablePcapAll (dir + "pcap/N", false);
